...
public class datePicker {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='metaFlightFrom']")).clear();
		driver.findElement(By.xpath("//*[@id='metaFlightFrom']")).sendKeys("Lviv");
		driver.findElement(By.xpath("//*[@id='metaFlightTo']")).sendKeys("Istanbul");
		driver.findElement(By.xpath("//*[@id='checkIn']")).click();
		String date = "10-July 2016";
	...
	public static void selectDate(String month_year, String day) throws InterruptedException {
		List<WebElement> elements = driver.findElements(
				By.xpath("//div[@class='calendar']/div[@class='month']/table/thead/tr/th[@class='caption']"));
